...
def pick_from_possible(possibilities, board):
    ...
    for col, value in possibilities.iteritems():
        ...
        for rotation, located in value.iteritems():
            ...
            possibilities[col][rotation]['points'] = possibilities[col][rotation]['points'] - (possibilities[col][rotation]['cleared'] * 8)
            # Get points for slopes

            # Get points for holes
            possibilities[col][rotation]['points'] = possibilities[col][rotation]['points'] - (possibilities[col][rotation]['holes'] * 8)
